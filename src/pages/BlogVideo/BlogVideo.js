...
const BlogVideo = () => {
    ...
    return (
        <div className='my-7'>
            ...
            {/* <iframe width="560" height="315" src="https:.com/embe-yVKcbg" title="YouTube video player" frameborder="0" allow="alerometplay; c; encrypted-media; gyroscopice" llscreen></iframe> */}
            <Swiper
