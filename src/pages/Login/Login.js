    ...
    return (
        <div className='flex flex-col justify-center items-center bg-gray-100 py-10'>
            <div className='w-[600px] bg-white pb-7'>
                <h1 className='text-gray-800 text-center font-bold text-3xl py-7'>Login to your account</h1>
                <form className='px-8 py-7 space-y-5'>
                    ...
                    <div className='flex justify-between items-center'>
                        <div>
                            ...
                            <p className='inline-block pl-5 text-xl text-gray-400'> Remember me</p>
                        </div>
